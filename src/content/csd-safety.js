...
export function safetyStep({ id = 1, estMin = 10 } = {}) {
  return {
    ...
    title: {
      ...
      ur: 'جانچ سے پہلے حفاظتی احتیاطیں',
    ...
    instructions: {
      ...
      ur: [
        'جس آلے کی جانچ کرنی ہے اس پر حفاظتی ٹیگ لگائیں۔',
        'علاقے کو حفاظتی انتباہی ٹیپ سے الگ کریں۔',
        'زیرِ جانچ آلے سے محفوظ فاصلہ رکھیں۔',
        'کوئی بھی جانچ شروع کرنے سے پہلے حفاظتی سامان پہنیں: حفاظتی ٹوپ، نمایاں نظر آنے والا لباس، حفاظتی دستانے اور حفاظتی جوتے۔',
        'کوئی بھی جانچ کا آلہ جوڑنے سے پہلے درست ارتھنگ کریں۔',
        'خود جانچ: پہلا جوڑ لگانے سے پہلے پانچوں احتیاطیں مکمل ہوں۔',
      ],
      hi: [
    ...
    tools: {
      ...
      ur: ['حفاظتی ٹیگ', 'انتباہی ٹیپ', 'ارتھنگ سیٹ', 'حفاظتی سامان کا سیٹ'],
    ...
    warning: {
      ...
      ur: 'یہ پانچوں احتیاطیں جانچ سے پہلے، دوران اور بعد میں لاگو ہوتی ہیں۔ جب تک سب مکمل نہ ہوں کوئی جانچ شروع نہ کریں۔',
