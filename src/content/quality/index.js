...
export const ITP = {
  ...
  items: [
    {
      no: '1.1 a', type: 'W',
      test: { en: 'Power frequency withstand voltage — main circuit', ar: 'تحمّل الجهد بتردد الشبكة — الدائرة الرئيسية', ur: 'پاور فریکوئنسی وِد اسٹینڈ وولٹیج — مین سرکٹ', hi: 'पावर फ़्रीक्वेंसी विदस्टैंड वोल्टेज — मेन सर्किट', fr: 'Tenue à fréquence industrielle — circuit principal' },
      std: 'IEC 62271-200, 7.1',
      proc: '13.8 kV: 38 kV (60 s) · 36 kV: 70 kV (60 s) · ±1% · 45–65 Hz',
      accept: { en: 'No disruptive discharge', ar: 'لا يحدث تفريغ كهربائي', ur: 'کوئی ڈسرپٹو ڈسچارج نہ ہو', hi: 'कोई डिसरप्टिव डिस्चार्ज न हो', fr: 'Aucune décharge disruptive' },
    },
    {
      no: '1.1 b', type: 'W',
      test: { en: 'Withstand test on auxiliary and control circuits', ar: 'اختبار التحمّل لدوائر التغذية المساعدة والتحكم', ur: 'آگزیلری اور کنٹرول سرکٹ پر وِد اسٹینڈ ٹیسٹ', hi: 'ऑग्ज़िलरी और कंट्रोल सर्किट पर विदस्टैंड टेस्ट', fr: 'Essai de tenue sur circuits auxiliaires et de commande' },
      std: 'IEC 62271-200, 7.2',
      proc: '2 kV · 60 s · ±1% · 45–65 Hz',
      accept: { en: 'No disruptive discharge during each test', ar: 'لا يحدث تفريغ أثناء أي اختبار', ur: 'ہر ٹیسٹ کے دوران کوئی ڈسچارج نہ ہو', hi: 'हर टेस्ट के दौरान कोई डिस्चार्ज न हो', fr: 'Aucune décharge pendant chaque essai' },
    },
    {
      no: '1.2', type: 'W',
      test: { en: 'Resistance of the main circuit (sample panel)', ar: 'مقاومة الدائرة الرئيسية (لوحة عيّنة)', ur: 'مین سرکٹ کی مزاحمت (سیمپل پینل)', hi: 'मेन सर्किट की रेज़िस्टेंस (सैंपल पैनल)', fr: 'Résistance du circuit principal (panneau échantillon)' },
      std: 'IEC 62271-200, 7.3',
      proc: '50 A ≤ Idc ≤ rated normal current',
      accept: { en: 'Must not differ by more than 20% from the resistance measured before the temperature-rise test', ar: 'ألا تختلف بأكثر من 20% عن المقاومة المقاسة قبل اختبار ارتفاع الحرارة', ur: 'ٹمپریچر رائز ٹیسٹ سے پہلے ماپی گئی مزاحمت سے 20% سے زیادہ فرق نہ ہو', hi: 'टेम्परेचर-राइज़ टेस्ट से पहले मापी गई रेज़िस्टेंस से 20% से ज़्यादा अंतर न हो', fr: 'Ne doit pas s’écarter de plus de 20 % de la résistance mesurée avant l’essai d’échauffement' },
    },
    {
      no: '1.3', type: 'W',
      test: { en: 'Tightness test', ar: 'اختبار الإحكام', ur: 'ٹائٹنس ٹیسٹ', hi: 'टाइटनेस टेस्ट', fr: 'Essai d’étanchéité' },
      std: 'IEC 62271-200, 7.4',
      proc: 'All current ratings for the bay',
      accept: { en: 'Gas tightness measured together with the tests of 6.102 and 6.106 on each type of compartment; leakage within the declared rate', ar: 'يُقاس إحكام الغاز مع اختبارات 6.102 و6.106 لكل نوع حجرة؛ والتسرّب ضمن المعدل المعلن', ur: 'گیس ٹائٹنس 6.102 اور 6.106 کے ٹیسٹ کے ساتھ ہر قسم کے کمپارٹمنٹ پر ماپی جائے؛ لیکیج اعلان کردہ حد میں ہو', hi: 'गैस टाइटनेस 6.102 और 6.106 के टेस्ट के साथ हर तरह के कम्पार्टमेंट पर मापी जाए; लीकेज घोषित दर के भीतर हो', fr: 'Étanchéité mesurée avec les essais 6.102 et 6.106 sur chaque type de compartiment ; fuite dans la limite déclarée' },
    },
    {
      no: '1.6', type: 'RC',
      test: { en: 'Pressure test of the enclosure', ar: 'اختبار ضغط الحاوية', ur: 'انکلوژر کا پریشر ٹیسٹ', hi: 'एनक्लोज़र का प्रेशर टेस्ट', fr: 'Essai de pression de l’enveloppe' },
      std: 'IEC 62271-200',
      proc: 'As per manometer indication, all enclosures',
      accept: { en: 'Pressure holds as declared for the enclosure', ar: 'يبقى الضغط كما هو معلن للحاوية', ur: 'پریشر انکلوژر کے اعلان کردہ مطابق برقرار رہے', hi: 'प्रेशर एनक्लोज़र के घोषित मान पर बना रहे', fr: 'La pression se maintient à la valeur déclarée' },
    },
    {
      no: '2.1', type: 'W',
      test: { en: 'Circuit breaker — mechanical operation, open and closed positions', ar: 'قاطع الدائرة — التشغيل الميكانيكي، وضعا الفتح والغلق', ur: 'سرکٹ بریکر — مکینیکل آپریشن، اوپن اور کلوز پوزیشن', hi: 'सर्किट ब्रेकर — मैकेनिकल ऑपरेशन, ओपन और क्लोज़ पोज़ीशन', fr: 'Disjoncteur — manœuvre mécanique, positions ouvert et fermé' },
      std: 'IEC 62271-100, 7.101',
      proc: '5 operations or attempts',
      accept: { en: 'The switching device opens and closes correctly on every operation', ar: 'يفتح جهاز القطع ويغلق بشكل صحيح في كل عملية', ur: 'سوئچنگ ڈیوائس ہر آپریشن پر درست کھلے اور بند ہو', hi: 'स्विचिंग डिवाइस हर ऑपरेशन पर सही खुले और बंद हो', fr: 'L’appareil s’ouvre et se ferme correctement à chaque manœuvre' },
    },
    {
      no: '2.2', type: 'W',
      test: { en: 'Circuit breaker — timing test', ar: 'قاطع الدائرة — اختبار التوقيت', ur: 'سرکٹ بریکر — ٹائمنگ ٹیسٹ', hi: 'सर्किट ब्रेकर — टाइमिंग टेस्ट', fr: 'Disjoncteur — essai de chronométrage' },
      std: 'IEC 62271-100',
    ...
    {
      no: '3', type: 'W',
      test: { en: 'Earthing switch & disconnector — operation and interlocks', ar: 'مفتاح التأريض والفاصل — التشغيل والتعشيقات', ur: 'ارتھنگ سوئچ اور ڈس کنیکٹر — آپریشن اور انٹرلاک', hi: 'अर्थिंग स्विच और डिस्कनेक्टर — ऑपरेशन और इंटरलॉक', fr: 'Sectionneur de terre et sectionneur — manœuvre et verrouillages' },
      std: 'IEC 62271-102',
    ...
    {
      no: '4.6', type: 'RC',
      test: { en: 'Voltage transformer — accuracy test', ar: 'محوّل الجهد — اختبار الدقة', ur: 'وولٹیج ٹرانسفارمر — ایکوریسی ٹیسٹ', hi: 'वोल्टेज ट्रांसफ़ॉर्मर — एक्युरेसी टेस्ट', fr: 'Transformateur de tension — essai de précision' },
      std: 'IEC 61869-3, 7.3.5',
      proc: 'As per IEC 61869-3, 7.3.5',
      accept: { en: 'Errors within the limits specified for the declared accuracy class', ar: 'الأخطاء ضمن الحدود المحددة لفئة الدقة المعلنة', ur: 'اعلان کردہ ایکوریسی کلاس کی مقررہ حدود میں غلطیاں ہوں', hi: 'घोषित एक्युरेसी क्लास की तय सीमाओं के भीतर त्रुटियाँ हों', fr: 'Erreurs dans les limites de la classe de précision déclarée' },
    },
    {
      no: '5.5', type: 'RC',
      test: { en: 'Current transformer — accuracy test', ar: 'محوّل التيار — اختبار الدقة', ur: 'کرنٹ ٹرانسفارمر — ایکوریسی ٹیسٹ', hi: 'करंट ट्रांसफ़ॉर्मर — एक्युरेसी टेस्ट', fr: 'Transformateur de courant — essai de précision' },
...
export const FAT = {
  ...
  sub: {
    ...
    ur: 'تھرڈ پارٹی انسپکٹر نے کیا اٹھایا، اور ہر نکتہ کیسے کلیئر ہوا',
  ...
  items: [
    { no: 1, cleared: true, on: '27.07.2026',
      desc: { en: 'CT1 & CT2 label on the backside of the front door to be fixed properly on the proposed witness panel', ar: 'تثبيت ملصق CT1 وCT2 خلف الباب الأمامي بشكل صحيح على لوحة الشهود المقترحة', ur: 'سامنے کے دروازے کی پشت پر CT1 اور CT2 لیبل تجویز کردہ وٹنس پینل پر درست لگایا جائے', hi: 'सामने के दरवाज़े के पीछे CT1 और CT2 लेबल प्रस्तावित विटनेस पैनल पर सही लगाया जाए', fr: 'Étiquette CT1 et CT2 au dos de la porte avant à fixer correctement sur le panneau témoin' },
    ...
    { no: 2, cleared: true, on: '27.07.2026',
      desc: { en: 'VCB label to be fixed properly on the proposed witness panel', ar: 'تثبيت ملصق VCB بشكل صحيح على لوحة الشهود المقترحة', ur: 'VCB لیبل تجویز کردہ وٹنس پینل پر درست لگایا جائے', hi: 'VCB लेबल प्रस्तावित विटनेस पैनल पर सही लगाया जाए', fr: 'Étiquette VCB à fixer correctement sur le panneau témoin' },
      reply: { en: 'Complied — photo attached', ar: 'تم الامتثال — الصورة مرفقة', ur: 'تعمیل ہو گئی — تصویر منسلک', hi: 'अनुपालन हुआ — फ़ोटो संलग्न', fr: 'Conforme — photo jointe' } },
    { no: 3, cleared: true, on: '27.07.2026',
      desc: { en: 'Door limit switch label found missing on the proposed witness panel', ar: 'ملصق مفتاح حد الباب مفقود على لوحة الشهود المقترحة', ur: 'تجویز کردہ وٹنس پینل پر ڈور لمٹ سوئچ کا لیبل غائب پایا گیا', hi: 'प्रस्तावित विटनेस पैनल पर डोर लिमिट स्विच का लेबल गायब मिला', fr: 'Étiquette du fin de course de porte manquante sur le panneau témoin' },
      reply: { en: 'Complied — photo attached', ar: 'تم الامتثال — الصورة مرفقة', ur: 'تعمیل ہو گئی — تصویر منسلک', hi: 'अनुपालन हुआ — फ़ोटो संलग्न', fr: 'Conforme — photo jointe' } },
    ...
    { no: 6, cleared: true, on: '27.07.2026',
      desc: { en: 'All tags to be installed with the engraved type', ar: 'تركيب كل اللافتات من النوع المحفور', ur: 'تمام ٹیگ اینگریوڈ قسم کے لگائے جائیں', hi: 'सभी टैग एनग्रेव्ड प्रकार के लगाए जाएँ', fr: 'Toutes les étiquettes doivent être du type gravé' },
      reply: { en: 'Comply', ar: 'مطابق', ur: 'تعمیل', hi: 'अनुपालन', fr: 'Conforme' } },
    { no: 7, cleared: true, on: '27.07.2026',
      desc: { en: 'Cable gasket to be provided on the proposed witness panel', ar: 'توفير حشية الكابل على لوحة الشهود المقترحة', ur: 'تجویز کردہ وٹنس پینل پر کیبل گاسکٹ فراہم کی جائے', hi: 'प्रस्तावित विटनेस पैनल पर केबल गास्केट दिया जाए', fr: 'Prévoir un joint de câble sur le panneau témoin' },
      reply: { en: 'Complied — photo attached', ar: 'تم الامتثال — الصورة مرفقة', ur: 'تعمیل ہو گئی — تصویر منسلک', hi: 'अनुपालन हुआ — फ़ोटो संलग्न', fr: 'Conforme — photo jointe' } },
    { no: 8, cleared: true, on: '27.07.2026',
      desc: { en: 'Routine test reports to be provided for all panels', ar: 'تقديم تقارير الاختبار الروتيني لكل اللوحات', ur: 'تمام پینلوں کی روٹین ٹیسٹ رپورٹیں فراہم کی جائیں', hi: 'सभी पैनलों की रूटीन टेस्ट रिपोर्ट दी जाए', fr: 'Fournir les rapports d’essais de série pour tous les panneaux' },
    ...
    { no: 9, cleared: true, on: '27.07.2026',
      desc: { en: 'All review certificates to be provided as per the ITP', ar: 'تقديم كل شهادات المراجعة وفق خطة الفحص والاختبار', ur: 'ITP کے مطابق تمام ریویو سرٹیفکیٹ فراہم کیے جائیں', hi: 'ITP के अनुसार सभी रिव्यू सर्टिफ़िकेट दिए जाएँ', fr: 'Fournir tous les certificats de revue conformément à l’ITP' },
      reply: { en: 'Attached document provided', ar: 'تم تقديم المستند المرفق', ur: 'منسلک دستاویز فراہم کر دی گئی', hi: 'संलग्न दस्तावेज़ दिया गया', fr: 'Document joint fourni' } },
  ],
...
export const DEFECTS = {
  ...
  intro: {
    ...
    ur: 'سائٹ سے واپس آنے والے پینل جانچے جاتے ہیں تاکہ نقل و حمل، اتارنے یا تنصیب کے دوران ہونے والا نقصان معلوم ہو۔ نیچے ہر آئٹم کو تبدیلی درکار ہے — لاپروا ہینڈلنگ کی یہی قیمت ہے۔',
  ...
  observations: [
    ...
    { no: 4, name: { en: 'Control cable entry duct damage', ar: 'تلف مجرى دخول كابل التحكم', ur: 'کنٹرول کیبل انٹری ڈکٹ خراب', hi: 'कंट्रोल केबल एंट्री डक्ट खराब', fr: 'Goulotte d’entrée des câbles de commande endommagée' } },
    { no: 5, name: { en: 'End cover damage', ar: 'تلف الغطاء الطرفي', ur: 'اینڈ کور خراب', hi: 'एंड कवर खराब', fr: 'Capot d’extrémité endommagé' } },
    { no: 6, name: { en: 'Panel top sheet damage', ar: 'تلف اللوح العلوي للوحة', ur: 'پینل کی اوپری شیٹ خراب', hi: 'पैनल की ऊपरी शीट खराब', fr: 'Tôle supérieure du panneau endommagée' } },
    { no: 7, name: { en: 'LV top control cable entry duct damage', ar: 'تلف مجرى كابل التحكم العلوي للجهد المنخفض', ur: 'LV اوپری کنٹرول کیبل انٹری ڈکٹ خراب', hi: 'LV ऊपरी कंट्रोल केबल एंट्री डक्ट खराब', fr: 'Goulotte supérieure BT endommagée' } },
    { no: 8, name: { en: 'Lift hook damage', ar: 'تلف خطاف الرفع', ur: 'لفٹ ہک خراب', hi: 'लिफ़्ट हुक खराब', fr: 'Anneau de levage endommagé' } },
    ...
    { no: 10, name: { en: 'LV top sheet damage', ar: 'تلف اللوح العلوي للجهد المنخفض', ur: 'LV اوپری شیٹ خراب', hi: 'LV ऊपरी शीट खराब', fr: 'Tôle supérieure BT endommagée' } },
    { no: 11, name: { en: 'VCB facial cover damage', ar: 'تلف الغطاء الأمامي للقاطع VCB', ur: 'VCB کا فرنٹ کور خراب', hi: 'VCB का फ़्रंट कवर खराब', fr: 'Capot frontal du VCB endommagé' } },
    { no: 12, name: { en: 'VCB tulip plastic cover damaged', ar: 'تلف الغطاء البلاستيكي لتوليب القاطع VCB', ur: 'VCB ٹیولپ کا پلاسٹک کور خراب', hi: 'VCB ट्यूलिप का प्लास्टिक कवर खराब', fr: 'Capot plastique des tulipes VCB endommagé' } },
  ].map((o) => ({
    ...o,
  ...
  functional: [
    { id: 'F1', name: { en: 'Main relay function', ar: 'وظيفة المرحّل الرئيسي', ur: 'مین ریلے فنکشن', hi: 'मेन रिले फंक्शन', fr: 'Fonction relais principal' }, state: 'ok' },
    { id: 'F2', name: { en: 'VCB racking function', ar: 'وظيفة إدخال وإخراج القاطع', ur: 'VCB ریکنگ فنکشن', hi: 'VCB रैकिंग फंक्शन', fr: 'Fonction d’embrochage VCB' }, state: 'damaged' },
    { id: 'F3', name: { en: 'VCB door interlock function', ar: 'وظيفة تعشيق باب القاطع', ur: 'VCB ڈور انٹرلاک فنکشن', hi: 'VCB डोर इंटरलॉक फंक्शन', fr: 'Verrouillage de porte VCB' }, state: 'ok' },
    { id: 'F4', name: { en: 'VCB to earthing interlock function', ar: 'وظيفة تعشيق القاطع مع التأريض', ur: 'VCB تا ارتھنگ انٹرلاک فنکشن', hi: 'VCB से अर्थिंग इंटरलॉक फंक्शन', fr: 'Verrouillage VCB / mise à la terre' }, state: 'ok' },
    { id: 'F5', name: { en: 'VT door interlock function', ar: 'وظيفة تعشيق باب محوّل الجهد', ur: 'VT ڈور انٹرلاک فنکشن', hi: 'VT डोर इंटरलॉक फंक्शन', fr: 'Verrouillage de porte TT' }, state: 'na' },
    { id: 'F6', name: { en: 'VT racking function', ar: 'وظيفة إدخال وإخراج محوّل الجهد', ur: 'VT ریکنگ فنکشن', hi: 'VT रैकिंग फंक्शन', fr: 'Fonction d’embrochage TT' }, state: 'na' },
    { id: 'F7', name: { en: 'Earthing function', ar: 'وظيفة التأريض', ur: 'ارتھنگ فنکشن', hi: 'अर्थिंग फंक्शन', fr: 'Fonction de mise à la terre' }, state: 'ok' },
  ],
}
...
export const MARKS = {
  ...
  sub: {
    ...
    ur: 'ورک انسٹرکشن کی تصاویر پر تیر، دائرے اور مارکر کے رنگ کیا معنی رکھتے ہیں',
  ...
  keys: [
    ...
    },
    {
      ...
      means: {
        ...
        ur: 'پروڈکشن کی اپنی بصری تصدیق: آپریٹر نے جوڑ کو ٹارک کر کے چیک کیا۔ بولٹ اور نٹ پر نیلی لکیر کا مطلب ہے کام ہو چکا۔',
    ...
    },
    {
      ...
      means: {
        ...
        ur: 'کوالٹی کنٹرول کی تصدیق، نیلے کے اوپر لگائی جاتی ہے۔ جوڑ پر دونوں لکیریں تبھی ہوتی ہیں جب QC تصدیق کر لے — سرخ نشان خود کبھی نہ لگائیں۔',
